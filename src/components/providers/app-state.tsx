...
type ModalState = { type: "auth"; tab: AuthTab } | { type: "rewards" } | null;
...
export function AppStateProvider({
  ...
  const value = useMemo(
    () => ({ user, setUser, modal, openSignIn, openSignUp, openRewards, closeModal, setAuthTab }),
    [user, modal, openSignIn, openSignUp, openRewards, closeModal, setAuthTab]
  );
